...
import com.softsquared.wadiz.src.Item.itemMain.ItemPurchase.ItemPurchaseFirst.interfaces.MainRetrofitInterface;
...
class MainService {
    ...
    void getReward(int projectIdx, String token) {
        ...
        mainRetrofitInterface.getReward(projectIdx, token).enqueue(new Callback<DefaultResponse>() {
            @Override
            public void onResponse(Call<DefaultResponse> call, Response<DefaultResponse> response) {
                ...
                mMainActivityView.validateSuccess(defaultResponse.getItem());
            }
